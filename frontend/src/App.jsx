...
function App() {
  ...
  const typewriterTexts = [
    "I am a software developer with skills in Front end as well as Back end Technologies.",
    "Passionate about creating innovative solutions and learning new technologies.",
    "Experienced in Python, Java, React, and cloud technologies.",
    "Always eager to take on new challenges and grow professionally."
  ];
  ...
  return (
    <div className="portfolio-app">
      <div className="main-layout">
        {/* Left Section - Profile and Chat */}
        <div className="left-section">
          {/* Top Left - Profile Picture and Description */}
